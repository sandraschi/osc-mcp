...
1. **Copy the health module:**
   ```bash
   # Already in: src/oscmcp/sync_health.py
   ```
...
1. **Copy the module:**
   ```bash
   cp src/oscmcp/sync_health.py your_project/
   ```
...
- 📄 [sync_health.py](../../src/oscmcp/sync_health.py) - Health module
