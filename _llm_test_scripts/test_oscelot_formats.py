...
async def test_formats(module_id=14, param_id=3, port=10001):
    ...
    for i, fmt in enumerate(formats, 1):
        ...
        print("   Setting to LOW (C4 = 261.63 Hz)...")
        # Set low
        ...
        print("   Setting to HIGH (A4 = 440 Hz)...")
        # Set high
...
if __name__ == "__main__":
    ...
    parser.add_argument("--module-id", type=int, default=14, help="Module ID (default: 14)")
    parser.add_argument("--param-id", type=int, default=3, help="Parameter ID (default: 3)")
    parser.add_argument("--port", type=int, default=10001, help="OSC port (default: 10001)")
    args = parser.parse_args()

    asyncio.run(test_formats(module_id=args.module_id, param_id=args.param_id, port=args.port))
