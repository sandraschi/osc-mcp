...
FRERE_JACQUES_MELODY = [
    ...
    (60, 0.5), (62, 0.5), (64, 0.5), (60, 0.5),  # C D E C
    (60, 0.5), (62, 0.5), (64, 0.5), (60, 0.5),  # C D E C
    
    # Dormez-vous? Dormez-vous?
    (64, 0.5), (65, 0.5), (67, 1.0),              # E F G (long)
    (64, 0.5), (65, 0.5), (67, 1.0),              # E F G (long)
    
    # Sonnez les matines, sonnez les matines
    (67, 0.25), (69, 0.25), (67, 0.25), (65, 0.25), (64, 0.5), (60, 0.5),  # G A G F E C
    (67, 0.25), (69, 0.25), (67, 0.25), (65, 0.25), (64, 0.5), (60, 0.5),  # G A G F E C
    
    # Ding ding dong, ding ding dong
    (60, 0.5), (55, 0.5), (60, 1.0),              # C G(low) C (long)
    (60, 0.5), (55, 0.5), (60, 1.0),              # C G(low) C (long)
]
