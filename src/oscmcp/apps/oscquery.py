...
class OSCQueryBrowser:
    ...
    def _service_state_change(self, zeroconf: Zeroconf, 
                            service_type: str, 
                            name: str, 
    ...
    async def _add_service(self, zeroconf: Zeroconf, 
                         service_type: str, 
                         name: str) -> None:
...
class OSCQueryServer:
    ...
    async def _start_zeroconf(self) -> None:
        ...
        # Create service info
        service_name = f"{self.name}._oscjson._tcp.local."
