...
class MIDIBridge:
    ...
    def add_midi_to_osc_mapping(self, 
                              ...
                              round_midi: bool = True,
                              invert: bool = False,
                              send_note_off: bool = False) -> MIDIMapping:
    ...
    def add_osc_to_midi_mapping(self,
                              osc_address: str,
                              midi_type: Union[MIDIType, str, int],
                              channel: int,
                              control: Optional[int],
            ...
            try:
                ...
                if mapping.control is not None:
                    ...
                    if mapping.midi_type == MIDIType.PROGRAM_CHANGE:
                        ...
                        logger.warning(f"Unsupported MIDI type for OSC to MIDI mapping without control: {mapping.midi_type}")
                        continue
