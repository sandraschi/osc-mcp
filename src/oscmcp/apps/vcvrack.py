...
class VCVController:
    ...
    async def start(self) -> None:
        ...
        logger.info(f"VCV Rack OSC interface started. Listening on port {self.listen_port}, sending to port {self.target_port}")
    ...
    def on_parameter_change(self, module_id: int, param_id: int, 
