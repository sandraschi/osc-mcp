          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Disable all screen-space effects
                </p>
              </div>
              <Switch
                onCheckedChange={(checked) =>
                  callManager("set_parameter", {
                    path: "/project1/postfx/bypass",
                    value: checked ? 1 : 0,
                  })
                }
                disabled={loading}
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Pause all solver calculations
                </p>
              </div>
              <Switch
                onCheckedChange={(checked) =>
                  callManager("set_parameter", {
                    path: "/project1/simulation/freeze",
                    value: checked ? 1 : 0,
                  })
                }
                disabled={loading}
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueCommit={(val) =>
                  callManager("set_parameter", {
                    path: "/project1/particles/density",
                    value: val[0] / 100,
                  })
                }
              />
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                onValueCommit={(val) =>
                  callManager("set_parameter", {
                    path: "/project1/postfx/bloom_thresh",
                    value: val[0] / 100,
                  })
                }
              />
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {["Brightness", "Contrast", "Saturation", "Hue"].map((param) => (
              <div
                key={param}
                className="space-y-2 border rounded-lg p-3 bg-slate-500/5"
              >
