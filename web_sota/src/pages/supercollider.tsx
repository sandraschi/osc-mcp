                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Slider
                                defaultValue={[25]} max={100}
                                onValueCommit={(val) => callManager('set_node_parameter', { node_id: 1000, parameter: 'amp', value: val[0] / 100 })}
                            />
                        </div>
                        <div className="space-y-2">
                            <div className="flex justify-between text-sm font-mono">
                            ...
                            <Slider
                                defaultValue={[440]} max={2000} min={20}
                                onValueCommit={(val) => callManager('set_node_parameter', { node_id: 1000, parameter: 'freq', value: val[0] })}
                            />
                        </div>
                    </CardContent>
                </Card>
