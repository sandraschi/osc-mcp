    ...
    <div className="space-y-6" data-testid="api-docs-page">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">FastAPI auto-generated docs for the OSC-MCP REST API</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border-slate-800 bg-slate-950/50">
          ...
          <CardContent className="text-xs text-slate-400 space-y-1">
            ...
            <code className="block text-emerald-400">GET /api/v1/capabilities</code>
          </CardContent>
        </Card>
        <Card className="border-slate-800 bg-slate-950/50">
          ...
          <CardContent className="text-xs text-slate-400 space-y-1">
            ...
            <code className="block text-amber-400">POST /api/v1/tools/call</code>
          </CardContent>
        </Card>
        <Card className="border-slate-800 bg-slate-950/50">
          <CardHeader><CardTitle className="text-sm text-slate-200">Discovery</CardTitle></CardHeader>
          <CardContent className="text-xs text-slate-400 space-y-1">
            <code className="block text-purple-400">GET /api/v1/skills/</code>
            <code className="block text-purple-400">GET /api/v1/skills/{name}</code>
            <code className="block text-purple-400">GET /api/v1/llm/discover</code>
          </CardContent>
        </Card>
      </div>
      <div className="rounded-lg border border-slate-800 bg-slate-950/30 overflow-hidden" style={{ height: "70vh" }}>
        <iframe src={`${backendUrl}/docs`} className="w-full h-full border-0" title="Swagger UI"
