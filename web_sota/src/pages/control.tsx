...
import { Activity, Play, Power, RefreshCw, Square, Zap } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            Direct VCV Rack parameter orchestration
          </p>
        </div>
          ...
          <Card className="border-slate-800 bg-slate-950/50">
            ...
            <CardContent>
              <div className="font-mono text-sm text-slate-400 space-y-2">
                <p>
                  [10:42:15] <span className="text-emerald-500">INFO</span> OSC
                  backend connected to VCV Rack
                </p>
                <p>
                  [10:41:22] <span className="text-yellow-500">WARN</span> UDP
                  Jitter detected (1.5ms)
                </p>
                <p>
                  [10:40:05] <span className="text-blue-500">DEBUG</span>{" "}
                  Mapping: /vco1/freq {"->"} Port 10767
                </p>
              </div>
            </CardContent>
          </Card>
  ...
  return (
    <Card className="border-slate-800 bg-slate-950/50 backdrop-blur-sm transition-all hover:bg-slate-900/50">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Badge
          variant="outline"
          className={`border-opacity-20 bg-opacity-10 capitalize ${getStatusColor(module.status)} border-current bg-current`}
        >
          {module.status}
        </Badge>
      </CardHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Progress
              ...
              indicatorClassName={
                module.cpu > 5 ? "bg-red-500" : "bg-emerald-500"
              }
            />
          </div>
        </div>
